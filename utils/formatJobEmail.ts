...
export const buildJobHtml = ({
  ...
  <div style="font-family: Arial, Helvetica, sans-serif; color:#111827; font-size:14px; line-height:1.6; max-width: 560px; margin: 0 auto; padding: 24px; border-left: 3px solid #3b08a1;">
    ...
    <p style="margin:0 0 4px 0; color:#6b7280; font-size:13px;">Before</p>
    <p style="margin:0 0 12px 0;">${photoLabel(beforeCount)} attached — how we found the space</p>

    <p style="margin:0 0 4px 0; color:#6b7280; font-size:13px;">After</p>
    <p style="margin:0 0 12px 0;">${photoLabel(afterCount)} attached — how we left it</p>
